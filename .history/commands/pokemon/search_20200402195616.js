...
module.exports = class SearchPokemon extends Command {
    ...
    run(message, { pokemon, shiny }) {
		...
		if (capitalize(shiny) == 'Shiny')
			sprite =`https://img.pokemondb.net/sprites/black-white/anim/shiny/${pokemon.toLowerCase()}.gif`;
		else sprite =`https://img.pokemondb.net/sprites/black-white/anim/normal/${pokemon.toLowerCase()}.gif`;
